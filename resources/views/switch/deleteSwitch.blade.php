...
@section('titolo')
{{ trans('labels.deleteConfigurationSwitchTitle') }}
@endsection
...
<div class="container text-center">
    <div class="row">
        <div class="col-md-12">
            <header>
                <h2>{{ trans('labels.switchDeleteMessage') }}</h2>
            </header>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <p>{{ trans('labels.switchUndoMessage') }}</p>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <p>{{ trans('labels.switchDeleteMessageFinal') }}</p>
                    <p><a class="btn btn-danger" href="{{ route('switch.destroy', ['serialNumber' => $switch->serialNumber]) }}"><span class='glyphicon glyphicon-trash'></span> {{ trans('labels.delete') }}</a></p>
                </div>
            </div>
        </div>
    </div>  
