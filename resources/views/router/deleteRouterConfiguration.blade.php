        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p><a class="btn btn-danger" href="{{ route('router.deleteConfiguration', ['serialNumber' => $router->serialNumber]) }}"><span class='glyphicon glyphicon-trash'></span> {{ trans('labels.delete') }}</a></p>
                </div>
            </div>
        </div>
    </div>  
